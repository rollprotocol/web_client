  ...
  return (
    <div id="products" className="w-full px-4 sm:px-8 py-12 sm:py-16 bg-white">
        ...
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 items-center">
          ...
          <div className="relative w-full lg:w-1/2 mx-auto rounded-[25px] overflow-hidden " style={{ maxWidth: '100%' }}>
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-4 xs:p-5 sm:p-7">
              ...
              <p className="text-gray-700 mb-4 sm:mb-7 text-left text-1xl xs:text-base sm:text-lg leading-tight xs:leading-6 sm:leading-7 max-w-[95%] sm:max-w-[90%]">
              ...
              <div className="flex flex-row justify-between mb-4 sm:mb-7 pr-4 sm:pr-6 mt-2">
                <div>
                  <p className="text-sm sm:text-sm uppercase text-black font-medium">USERS</p>
                  <p className="text-1xl sm:text-3xl text-black font-extrabold">50K+</p>
                </div>
                <div>
                  <p className="text-sm sm:text-sm uppercase text-black font-medium">MONTHLY TRANSACTIONS</p>
                  <p className="text-1xl sm:text-3xl text-black font-extrabold">$100K+</p>
                </div>
              </div>
              <div>
      ...
      <div id="rd" className="mb-8 sm:mb-12">
        <h2 className="text-2xl xs:text-3xl sm:text-4xl text-black font-extrabold mb-4 sm:mb-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col gap-4 sm:gap-6">
            ...
            <div className="relative group cursor-pointer overflow-hidden rounded-xl sm:rounded-2xl md:mr-20 lg:mr-40">
              ...
              <div className="absolute top-2 sm:top-4 right-2 sm:right-4">
                <span className="bg-white text-1xl text-black font-medium px-2 py-1 rounded-full">
                  Cryptography
                </span>
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-3 xs:p-4 sm:p-6 bg-gradient-to-t from-black/80 to-transparent">
                ...
                >
                  <h3 className="text-white text-2xl xs:text-xl sm:text-2xl md:text-3xl font-extrabold mb-2">
          ...
          <div className="w-full md:w-1/2 mt-4 sm:mt-0">
            <div className="relative h-full group cursor-pointer overflow-hidden rounded-xl sm:rounded-2xl">
              ...
              <div className="absolute top-4 right-4">
                <span className="bg-white text-1xl text-black font-medium px-2 py-1 rounded-2xl">
                  Sustain
                </span>
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 bg-gradient-to-t from-black/80 to-transparent">
                <a 
                  ...
                  className="block cursor-pointer"
                >
                <h3 className="text-white text-2xl sm:text-2xl md:text-4xl font-extrabold mb-2">
    ...
    <div className="sm:hidden flex flex-col">
      ...
      <div className="bg-black rounded-xl text-white p-4 xs:p-6 mb-4 xs:mb-6">
        ...
        <h2 className="text-2xl xs:text-2xl font-extrabold mb-2 xs:mb-3">
          Start over.
          <br />
          Build better.
        </h2>
        <p className="text-xl xs:text-sm mb-4 xs:mb-6">
          The future of the Internet is open, decentralized, 
          and built for the next generation.
        </p>
        <a href="/careers" className="inline-block">
          <button className="gradient-border-btn-mobile">
            <span className='text-sm'>View Careers</span>
          </button>
        </a>
      </div>
